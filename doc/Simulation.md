...
```
basalt_vio_sim --cam-calib ~/.local/etc/basalt/euroc_ds_calib.json --marg-data sim_marg_data --show-gui 1
```
...
```
basalt_mapper_sim --cam-calib ~/.local/etc/basalt/euroc_ds_calib.json --marg-data sim_marg_data --show-gui 1
```
